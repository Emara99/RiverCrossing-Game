...
public class Controller2 implements Initializable {
	...
	public void Sort() {
		System.out.println("Recieved: " + controller2.getCrossersOnLeftBank());

		for (int i = 0; i < controller2.getCrossersOnLeftBank().size(); i++) {

			if (controller2.getCrossersOnLeftBank().get(i) instanceof Herbivorous) {
			...
			if (controller2.getCrossersOnLeftBank().get(i) instanceof Farmer) {

				System.out.println("ASDF");
				TranslateTransition transition3 = new TranslateTransition();
				transition3.setDuration(Duration.seconds(0.1));
				
				if (controller2.getcF1() %2 != 0) {
					transition3.setNode(farmer1);
				}
				else if (controller2.getcF2() %2 != 0) {
					transition3.setNode(farmer2);
					}
				else if (controller2.getcF3() %2 != 0) {
					transition3.setNode(farmer3);
					}
				else if (controller2.getcF4() %2 != 0) {
					transition3.setNode(farmer4);
					}
				transition3.setToX(-210);
...
//			if (controller2.getCrossersOnLeftBank().get(i).equals(farmer2)) {
//
//				TranslateTransition transition3 = new TranslateTransition();
//				transition3.setDuration(Duration.seconds(0.1));
//				transition3.setNode(farmer2);
...
//
//			}
//			if (controller2.getCrossersOnLeftBank().get(i).equals(farmer3)) {
//
//				TranslateTransition transition5 = new TranslateTransition();
//				transition5.setDuration(Duration.seconds(0.1));
//				transition5.setNode(farmer3);
//				transition5.setToX(-210);
//
//				transition5.play();
//
//			}
//
//			if (controller2.getCrossersOnLeftBank().get(i).equals(farmer4)) {
//
//				TranslateTransition transition6 = new TranslateTransition();
//				transition6.setDuration(Duration.seconds(0.1));
//				transition6.setNode(farmer4);
//				transition6.setToX(-210);
//
//				transition6.play();
//
//			}
			...
			if (controller2.getNumberOfSails() % 2 == 1) {
...
public void solve() {
		...
		Media media = new Media(Paths.get("C:\\Users\\omare\\Videos\\Captures\\Level2.mp4").toUri().toString());
		MediaPlayer mediaPlayer = new MediaPlayer(media);
		MediaView view = new MediaView(mediaPlayer);
		Group full = new Group();
		full.getChildren().addAll(view);
		Scene scene = new Scene(full, 860, 608);
		Stage stage = new Stage();
		stage.setScene(scene);
		stage.setTitle("Solve");
		stage.show();
